...
- 4 standard blocks without a German string: controls_if_else, controls_if_elseif, controls_if_if, text_create_join_item
...
| --- | --- | --- |
| `controls_repeat` | wiederhole %1 mal: | wiederhole %1-mal: |
