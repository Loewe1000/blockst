...
STYLE_TO_CATEGORY = {
    ...
    "variable_dynamic_blocks": "variablen",
...
def write_locale(path: Path, title: str, license_note: str, specs: dict) -> None:
    lines = [
        f"# {title}",
...
def main() -> int:
    ...
    modern_messages = load_messages_json(SOURCES / "msg_de.json")
    classic_messages = load_messages_classic(SOURCES / "msg_de_classic.js")
    ...
    jwinf_specs = {**robot, **turtle, **differing}
    write_locale(
